...
function theme_files() {
  ...
  if(strstr($_SERVER['SERVER_NAME'], 'localhost')){ 
    ...
    wp_enqueue_script('main-webduel-js', get_theme_file_uri('/bundled-assets/scripts.d89226242e9854b3310c.js' ), array("jquery"), '1.0', true);
    wp_enqueue_style( 'our-main-styles', get_theme_file_uri('/bundled-assets/styles.d89226242e9854b3310c.css'));
  }
